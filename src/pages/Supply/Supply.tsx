    ...
    <Container className="min-h-screen">
      ...
      <div className="mt-20">
        <div className=" grid grid-cols-1 lg:grid-cols-2">
          ...
          <div>
            <h2 className="text-slate-500"> Thirst</h2>
            ...
            <p className="text-4xl font-bold text-cyan-500 mt-5">$500</p>
            ...
            <div className="mt-8 flex">
              ...
              <div className="pl-5">
                <Button className="bg-cyan-500 ">Add to Cart</Button>
              </div>
            </div>

            <p className="text-xl mt-5 font-bold">Category: lorem</p>
          </div>
        </div>
      </div>
